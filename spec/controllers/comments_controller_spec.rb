...
describe "POST #create" do
    ...
    describe 'Question comment' do
      ...
      context "Authenticated user tries to leave comment with valid attributes" do
        ...
        it "increase comment count by 1" do
          expect { post :create, id: question_comment, commentable_type: question, comment: attributes_for(:comment), question_id: question.id, format: :json }.to change(question.comments, :count).by(1)
        end
      end
      ...
      context "Authenticated user tries to leave comment with invalid attributes" do
        ...
        it "doesnt change comment count" do
          expect { post :create, id: question_comment, commentable_type: question, comment: attributes_for(:invalid_comment), question_id: question.id, format: :json }.to_not change(Comment, :count)
        end
      end
    end
    ...
    describe 'Answer comment' do
      ...
      context "Authenticated user tries to leave comment with valid attributes" do
        ...
        it "increase comment count by 1" do
          expect { post :create, id: answer_comment, commentable_type: answer, comment: attributes_for(:comment), answer_id: answer.id, format: :json }.to change(answer.comments, :count).by(1)
        end
      end
      ...
      context "Authenticated user tries to leave comment with invalid attributes" do
        ...
        it "doesnt change comment count" do
          expect { post :create, id: answer_comment, commentable_type: answer, comment: attributes_for(:invalid_comment), answer_id: answer.id, format: :json }.to_not change(Comment, :count)
        end
      end
    end
  end
  ...
  describe "PATCH #update" do
    ...
    describe 'Question comment' do
      ...
      it "assigns the requested comment to @comment" do
        patch :update, id: question_comment, comment: attributes_for(:comment), format: :json
        expect(assigns(:question_comment)).to eq question_comment
      end

      it "changes comment attributes" do
        patch :update, id: question_comment, commentable_id: question, comment: { body: "new body" }, format: :json
    ...
    describe 'Answer comment' do
      ...
      it "assigns the requested comment to @comment" do
        patch :update, id: answer_comment, commentable_id: answer, comment: attributes_for(:comment), format: :json
        expect(assigns(:answer_comment)).to eq answer_comment
      end

      it "changes comment attributes" do
        patch :update, id: answer_comment, commentable_id: answer, comment: { body: "new body" }, format: :json
