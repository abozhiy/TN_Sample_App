...
describe "POST #create" do
    ...
    describe 'Question comment' do
      ...
      context "Authenticated user tries to leave comment with valid attributes" do
        ...
        it "increase comment count by 1" do
          expect { post :create, id: question_comment, commentable: question, comment: attributes_for(:comment), question_id: question.id, format: :js }.to change(question.comments, :count).by(1)
        end
      end
      ...
      context "Authenticated user tries to leave comment with invalid attributes" do
        ...
        it "doesnt change comment count" do
          expect { post :create, id: question_comment, commentable: question, comment: attributes_for(:invalid_comment), question_id: question.id, format: :js }.to_not change(Comment, :count)
        end
      end
    end
    ...
    describe 'Answer comment' do
      ...
      context "Authenticated user tries to leave comment with valid attributes" do
        ...
        it "increase comment count by 1" do
          expect { post :create, id: answer_comment, commentable: answer, comment: attributes_for(:comment), answer_id: answer.id, format: :js }.to change(answer.comments, :count).by(1)
        end
      end
      ...
      context "Authenticated user tries to leave comment with invalid attributes" do
        ...
        it "doesnt change comment count" do
          expect { post :create, id: answer_comment, commentable: answer, comment: attributes_for(:invalid_comment), answer_id: answer.id, format: :js }.to_not change(Comment, :count)
        end
      end
    end
  end
  ...
  describe "PATCH #update" do
    ...
    describe 'Question comment' do
      ...
      it "changes comment attributes" do
        patch :update, id: question_comment, commentable: question, comment: { body: "new body" }, format: :js
    ...
    describe 'Answer comment' do
      ...
      it "changes comment attributes" do
        patch :update, id: answer_comment, commentable: answer, comment: { body: "new body" }, format: :js
